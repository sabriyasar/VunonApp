...
export declare type PaperOnboardingDirectionType = 'horizontal' | 'vertical';
...
export interface PageContentProps extends Pick<PaperOnboardingItemType, 'title' | 'titleStyle' | 'description' | 'descriptionStyle' | 'image'> {
    index: number;
...
export interface PaperOnboardingProps extends Pick<Partial<PaperOnboardingItemType>, 'titleStyle' | 'descriptionStyle'>, Partial<PaperOnboardingIndicatorConfig>, Partial<PaperOnboardingCloseButtonConfig> {
    /**
...
export interface BackgroundProps extends Pick<PaperOnboardingIndicatorConfig, 'indicatorSize'> {
    /**
     * Array of pages/slides to present.
     * @type {Array<PaperOnboardingItemType>}
     */
...
export interface BackgroundCircleProps extends Pick<PaperOnboardingIndicatorConfig, 'indicatorSize'> {
    index: number;
    animatedIndex: Animated.Node<number>;
    animatedIndicatorsContainerPosition: Animated.Node<number>;
    color: string;
